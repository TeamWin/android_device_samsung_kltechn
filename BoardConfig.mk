...
ifdef KLTE_MARSHMALLOW
	TARGET_PREBUILT_KERNEL := device/samsung/kltechn/zImage-M
	TARGET_PREBUILT_DTB := device/samsung/kltechn/dtb.img-M
else
	TARGET_PREBUILT_KERNEL := device/samsung/kltechn/zImage-L
	TARGET_PREBUILT_DTB := device/samsung/kltechn/dtb.img-L
endif
...
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/kltechn/bootimg.mk
